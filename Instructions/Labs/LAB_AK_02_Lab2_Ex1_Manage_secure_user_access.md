...
8. Dans la page **Configurer les éléments de base** de l’Assistant **Ajouter un utilisateur**, entrez les informations suivantes :
    ...
    - Entrez le nouveau mot de passe d’administration dans le champ **Mot de passe** qui s’affiche 
...
5. Sur la page **Accès conditionnel | Stratégies**, dans la barre de menus en haut de la page, sélectionnez **+Nouvelle stratégie**.
...
12. Sélectionnez le champ déroulant **Sélectionner à quoi cette stratégie s’applique** pour afficher les différentes options du menu déroulant. Sélectionnez **Applications cloud**. 
...
12. Microsoft a implémenté une nouvelle stratégie de sécurité dans les tenants d’évaluation utilisés dans ses labos de formation. Tous les comptes d’utilisateur de test prédéfinis sont configurés afin que les étudiants puissent modifier leur mot de passe initial lors de leur prochaine connexion. Vous avez rencontré ceci précédemment lorsque vous vous êtes connecté à Microsoft 365 en tant qu’Administrateur MOD dans le premier exercice de labo. Vous devez le faire maintenant avec Adele. <br>
...
16. Sur la page **Bienvenue dans Microsoft 365**, sélectionnez l’icône **Word** qui s’affiche dans la colonne des icônes d’application sur le côté gauche de l’écran. Cela ouvre **Microsoft Word Online**. Cela confirme que vous pouvez accéder à une application Microsoft 365 après vous être connecté à l’aide de MFA.  <br/>
...
11. Dans la boîte de dialogue **Entrer le mot de passe**, entrez le nouveau mot de passe d’administration que vous avez affecté au compte de Holly, puis sélectionnez **Se connecter**. 
...
23. Un nouvel onglet s’ouvre et affiche la fenêtre **Modifier le mot de passe**. Dans le champ **Ancien mot de passe**, entrez le mot de passe existant de Holly, qui est le nouveau mot de passe d’administration. <br/>
...
25. Vous allez maintenant tester la fonctionnalité de seuil de verrouillage. Vous le ferez en utilisant le compte de Patti Fernandez. Sélectionnez l’icône utilisateur d’Holly Dickson dans le coin supérieur droit de l’écran puis, dans le menu qui s’affiche, sélectionnez **Se déconnecter**.  
...
27. Dans la fenêtre **Se connecter**, entrez **pattif@xxxxxZZZZZZ.onmicrosoft.com** (où xxxxxZZZZZZ est le préfixe de tenant fourni par votre fournisseur d’hébergement de labo), puis sélectionnez **Suivant**. 
...
30. Comme vous vous en rappelez, tous les comptes d’utilisateur de test prédéfinis dans votre tenant d’évaluation sont configurés afin que vous deviez modifier leur mot de passe initial lors de leur prochaine connexion. Lorsque la fenêtre **Mettre à jour votre mot de passe** s’affiche, vérifiez que votre tentative de connexion utilisant le mot de passe réel de Patti a réussi. <br>

    **Remarque :** Vous n’avez PAS besoin de finaliser le processus de connexion pour Patti, car il s’agit de votre dernier exercice de labo utilisant le contrôleur de domaine LON-DC1. Vous pouvez fermer toutes les applications sur LON-DC1.
